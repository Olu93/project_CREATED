...
% This distance computes the costs associated with aligning two sequences by taking into account changes, inserts, deletes and transpositions of elements. Each of these alignment operations is typically associated with a cost of 1. This allows us to directly compute the structural difference between two sequences regardless of their lengths. 
% Instead of computing a cost of 1 for every operation, we compute a cost of a distance between the feature vectors of each step. This cost function allows us to take not only the sequential differences into account but also feature differences. 
