...
For more information about these datasets we refer to \citeauthor{teinemaa_OutcomeOrientedPredictiveProcess_2018a}'s comparative study\cite{teinemaa_OutcomeOrientedPredictiveProcess_2018a}.
