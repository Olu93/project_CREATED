...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
        ...
        \caption{Shows an excerpt of the MNIST dataset. This is a structured dataset.}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
        ...
        \caption{Shows a number of heterogenous documents. A dataset like this would be called unstructured.}
    ...
    \begin{subfigure}[c]{0.7\textwidth}
        ...
        \caption{Shows multiple seqeuences of words. Each word forms a sentence. Therefore, this data is semi-structured.}
        \label{fig:semistructured}
    \end{subfigure}
       \caption{Figure shows schematic examples of static structured, dynamic semistructured data and unstructured data.}
