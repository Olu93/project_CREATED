...
% For modelling, the probabilities, we use a mixture of probability distributions. For binary encoded variables we use bernoulli ditributions.  For numerical event attributes a multivariate gaussian. We assume that each distribution is independent. There, we only have to compute their product.
