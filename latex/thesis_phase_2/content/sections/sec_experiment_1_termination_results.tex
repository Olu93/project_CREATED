...
Another surprise is the steep ascention of only model that uses tournament selection (\optional{RI-TS-TPC-SBM-RR}) towards the end of the generation process. The  model even overtakes the model that leads the model-configurations in terms of \optional{viability}. 
