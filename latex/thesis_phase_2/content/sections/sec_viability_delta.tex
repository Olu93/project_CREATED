...
\footnotetext{Obviously, the domain of the application decides where this threshold lies. One can always aregue that a confidence of 51\% is close to randomly guessing.}
