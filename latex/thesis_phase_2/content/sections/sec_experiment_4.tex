...
\autoref{fig:exp4-winner} also displays the vast difference in computation time for the evolutionary algorithms. Only the model using the \optional{Ranking-Recombination} seems slightly faster than the ones using Best-Breed and Fittest-Survivor as recombination methods.
