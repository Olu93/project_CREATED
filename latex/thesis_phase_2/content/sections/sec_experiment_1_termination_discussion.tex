...
However, models (\attention{RI-TS-TPC-SBM-RR}) falls below this level. This coincides with its sharp rise in feasibility. We assume this behavior relates to a bias of the feasibility measure towards shorter sequences.
The rise and decline of \attention{CBI-RWS-OPC-SBM-BBR} shortly before overtaking all other models in terms of similarity and sparcity indicate a trade-off between how close the counterfactual is to the factual and how feasible it is.     
