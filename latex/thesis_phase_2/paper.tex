...
\begin{appendices}
    \chapter{Experiments}
    % \section{Results of the Configuration Search}
    \begin{table}
        \centering
    ...
    % \section{Results of Experiment across all Datasets}
    \begin{table}
        \centering
        \input{./tables/generated/exp5-winner-datasets.tex}
...
\end{table}
  ...
  \begin{table}
      \centering    
      \resizebox{\linewidth}{!}{
      \input{./tables/counterfactuals/ES-EGW-CBI-ES-UC3-SBM-RR-IM-49-5.tex}
      }
      \caption{A comparison between the CBI-ES-UC3-SBM-RR and D4EL}
      % \label{fig:exp7-RR}
  \end{table}
  \begin{table}
      \centering    
      \resizebox{\linewidth}{!}{
      \input{./tables/counterfactuals/ES-EGW-CBI-RWS-OPC-SBM-FSR-IM-49-5.tex}
