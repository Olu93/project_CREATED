...
\begin{align}
    ...
    p(\mathbf{z}_{t+1}) & =
    % \prod_{t=1}^{T}
    p\left(\mathbf{h} \mid t, \mathbf{z}_{t}, \mathbf{u}_{t}\right) \\
    p(\mathbf{x}_{t}) & =
    % \prod_{t=1}^{T}
    p\left(\mathbf{f} \mid t, \mathbf{z}_{t}, \mathbf{u}_{t}\right)
\end{align}


\attention{ALSO MENTION additional assumptions or reductions.}
