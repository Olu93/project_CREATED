...
% \subfile{content/sections/sec_context_01}
% \subfile{content/sections/sec_issues_01}
...
These characteristics change \autoref{eq:probablistic_state_space} into \autoref{eq:encoder_probability}:
