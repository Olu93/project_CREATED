...
\newdualentry{RL}{RL}{Reinfrocement Learning}{An are within Machine Learning, which seeks to allow an intelligent agent to choose the right actions by maximizing the cumulative rewards of a task setting.}
