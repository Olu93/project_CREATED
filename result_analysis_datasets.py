...
readers = ["OutcomeBPIC12ReaderShort", "OutcomeBPIC12ReaderMedium", "OutcomeBPIC12ReaderFull"]
# %%
list_jsons = []
...
df = df.rename(index={"OutcomeBPIC12ReaderShort":"BPIC12-25", "OutcomeBPIC12ReaderMedium":"BPIC12-50", "OutcomeBPIC12ReaderFull":"BPIC12-Full"})
