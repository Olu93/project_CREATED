...
if __name__ == '__main__':
    ...
    # reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
    # reader = OutcomeTrafficFineReader(debug=DEBUG_VERBOSE, mode=task_mode).init_log(save_preprocessed).init_meta(DEBUG_INIT_META)
    # reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
    ...
    # reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
    # reader = OutcomeBPIC12Reader50(debug=DEBUG_VERBOSE, mode=task_mode).init_log(save_preprocessed).init_meta(DEBUG_INIT_META)
    # reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
    # reader = OutcomeBPIC12Reader75(debug=DEBUG_VERBOSE, mode=task_mode).init_log(save_preprocessed).init_meta(DEBUG_INIT_META)
    # reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
    # reader = OutcomeBPIC12Reader100(debug=DEBUG_VERBOSE, mode=task_mode).init_log(save_preprocessed).init_meta(DEBUG_INIT_META)
    # reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
    reader = OutcomeBPIC12ReaderFull(debug=DEBUG_VERBOSE, mode=TaskModes.OUTCOME_PREDEFINED).init_log(save_preprocessed).init_meta(DEBUG_INIT_META)
    reader.save(skip_viz=DEBUG_SKIP_VIZ, skip_stats=DEBUG_SKIP_STATS)
